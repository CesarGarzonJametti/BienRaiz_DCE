...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				//$resetPassLink = 'http://localhost/forgotpass/resetPassword.php?fp_code='.$uniqidStr;
				$resetPassLink = 'http://localhost/interfaces/BienRaiz-DCE-master/resetPassword.php?fp_code='.$uniqidStr;
				...
				//additional headers
				$headers .= 'From: BienRaizDCE<caritoam07@gmail.com>' . "\r\n";
				//send email
